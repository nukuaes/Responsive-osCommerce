...
*/
  ...
  define('MODULE_PAYMENT_SAGE_PAY_DIRECT_TEXT_PUBLIC_TITLE', 'Tarjeta de crédito (Gestionado por Sage Pay)');
  ...
  define('MODULE_PAYMENT_SAGE_PAY_DIRECT_ERROR_ADMIN_CURL', 'Este módulo requiere que cURL esté habilitado en PHP y no funcionará hasta que se haya habilitado en este servidor.');
  define('MODULE_PAYMENT_SAGE_PAY_DIRECT_ERROR_ADMIN_CONFIGURATION', 'Este módulo no funcionará hasta que configure los parametros de Login del Vendedor. Por favor configure los ajustes del modulo');

  define('MODULE_PAYMENT_SAGE_PAY_DIRECT_CREDIT_CARD_NEW', 'Introduzca nueva tarjeta');
  ...
  define('MODULE_PAYMENT_SAGE_PAY_DIRECT_ERROR_CARDOWNER', 'El nombre del propietario de la tarjeta se debe proporcionar para completar el pedido. Por favor, inténtelo de nuevo y si los problemas persisten, intente otra forma de pago.');
